              ...
              <div class="tab-content pt-2">
               ...
               <h5 class="card-title">Profile Details</h5>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">R1813116H</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Admission Number:</div>
                    <div class="col-lg-9 col-md-8">PH00001</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Attendance Type:</div>
                    <div class="col-lg-9 col-md-8">Boarder</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Form 1</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Term</div>
