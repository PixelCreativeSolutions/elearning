...
<head>
  ...
  <title>PH | Student Registration</title>
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="insert.php" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="admission" class="form-control" id="yourEmail" required>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                       <input type="text" name="regnumber" class="form-control" id="yourUsername" required>
